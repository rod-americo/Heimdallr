(() => {
    ...
    const currentPrototypesSection = document.getElementById('currentPrototypesSection');
    ...
    function renderLiveToday() {
        ...
        if (!currentPrototypes || !currentPrototypesSection) return;
        ...
        currentPrototypesSection.style.display = prototypes.length ? 'block' : 'none';
