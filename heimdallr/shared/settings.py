...
SEGMENTATION_CLAIM_TTL_SECONDS = int(os.getenv("HEIMDALLR_SEGMENTATION_CLAIM_TTL_SECONDS", "900"))
SEGMENTATION_CLAIM_HEARTBEAT_SECONDS = int(
    os.getenv("HEIMDALLR_SEGMENTATION_CLAIM_HEARTBEAT_SECONDS", "30")
)
SEGMENTATION_NO_PROGRESS_TIMEOUT_SECONDS = int(
    os.getenv("HEIMDALLR_SEGMENTATION_NO_PROGRESS_TIMEOUT_SECONDS", "600")
)
SEGMENTATION_SHUTDOWN_RETRIES = int(
    os.getenv("HEIMDALLR_SEGMENTATION_SHUTDOWN_RETRIES", "1")
)
...
METRICS_CLAIM_TTL_SECONDS = int(os.getenv("HEIMDALLR_METRICS_CLAIM_TTL_SECONDS", "900"))
METRICS_CLAIM_HEARTBEAT_SECONDS = int(
    os.getenv("HEIMDALLR_METRICS_CLAIM_HEARTBEAT_SECONDS", "30")
)
