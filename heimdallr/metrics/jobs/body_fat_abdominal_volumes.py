#!/usr/bin/env python3
"""Quantify abdominal VAT/SAT compartments across vertebral slabs T12-L5."""
...
def main() -> int:
    ...
    try:
        ...
        if ct_path is None or not ct_path.exists() or not sat_path.exists() or not vat_path.exists():
        ...
        if sat_mask.shape != vat_mask.shape or ct_data.shape != sat_mask.shape:
            payload["status"] = "skipped"
